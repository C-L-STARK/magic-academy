  ...
  return (
    <motion.div
      ...
      className={`bg-white border-2 overflow-hidden transition-all ${
        isOpen ? 'border-black shadow-lg' : 'border-gray-200 hover:border-gray-400:border-gray-500'
      }`}
    >
      <button
        onClick={onClick}
        className={`w-full flex items-center justify-between p-6 text-left transition-all ${
          isOpen ? 'bg-gray-50' : 'hover:bg-gray-50:bg-gray-900'
        }`}
      >
      ...
      <div className="max-w-5xl mx-auto px-6 py-20">
        ...
        >
          <div className="relative max-w-2xl mx-auto">
            <input
              ...
              className="w-full px-6 py-5 pr-32 text-lg border-2 border-gray-300 bg-white text-gray-900 focus:outline-none focus:border-black:border-white transition-all"
            />
        ...
        <section className="mb-16">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-3xl font-black text-gray-900">{t('faq.category.course')}</h2>
        ...
        <section className="mb-16">
          <div className="flex items-center gap-4 mb-8">
            <div className="w-1 h-12 bg-black"></div>
            <h2 className="text-3xl font-black text-gray-900">{t('faq.category.learning')}</h2>
            <span className="px-4 py-2 bg-black text-white text-sm font-bold">
        ...
        <section className="mb-16">
          <div className="flex items-center gap-4 mb-8">
            <div className="w-1 h-12 bg-black"></div>
            <h2 className="text-3xl font-black text-gray-900">{t('faq.category.pricing')}</h2>
            <span className="px-4 py-2 bg-black text-white text-sm font-bold">
        ...
        <section className="mb-16">
          <div className="flex items-center gap-4 mb-8">
            <div className="w-1 h-12 bg-black"></div>
            <h2 className="text-3xl font-black text-gray-900">{t('faq.category.support')}</h2>
            <span className="px-4 py-2 bg-black text-white text-sm font-bold">
        ...
        <section className="mb-16">
          <div className="flex items-center gap-4 mb-8">
            <div className="w-1 h-12 bg-black"></div>
            <h2 className="text-3xl font-black text-gray-900">{t('faq.category.other')}</h2>
            <span className="px-4 py-2 bg-black text-white text-sm font-bold">
        ...
        >
          ...
          <div className="relative bg-gradient-to-br from-black via-gray-900 to-black p-12 border-2 border-black text-center">
            ...
            <h3 className="text-3xl font-bold mb-4 text-white">{t('faq.contact.title')}</h3>
            <p className="text-lg mb-8 text-gray-300 max-w-2xl mx-auto">
              {t('faq.contact.desc')}
            </p>
            <button
              onClick={() => setIsEmailModalOpen(true)}
              className="px-10 py-4 bg-white text-black font-bold text-lg border-2 border-white hover:bg-gray-100:bg-gray-900 transition-all hover:shadow-lg"
            >
